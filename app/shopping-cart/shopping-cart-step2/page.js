...
import "@/css/shopping-cart-step2.css"
...
export default function shoppingCart2Page() {
    return (
        <div>
            ...
            <div className="j-shoppingCartBox justify-content-center mt-5 pt-3 row">
                {/* 商品項目 */}
                        ...
                        <div className="j-cartItemBox me-3 mb-2 d-flex flex-grow-1">
                            <div className="j-cartItem d-flex flex-grow-1">
                                <div className="j-cameraImg m-2 ">
                                    <img src="../shopping-cart-image/shoppingCartItemPhoto.png" alt="" className="object-fit-contain" />
                                </div>
                        ...
                        <div className="j-cartItemBox me-3 mb-2 d-flex">
                            <div className="shoppingLesson d-flex flex-column">
                                <div className="j-lessonImg m-2 ">
                                    <img src="../shopping-cart-image/lesson1.png" alt="" className="object-fit-contain" />
                                </div>
