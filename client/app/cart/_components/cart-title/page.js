...
export default function CartTitle({ count }) {
    return (
      <div className={`${styles['j-shoppingCartTitleBox']} d-flex justify-content-sm-center justify-content-xl-start align-items-end pt-5 ms-xl-5 ps-xl-2 ms-xxl-5 ps-xxl-4`}>
