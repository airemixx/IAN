...
export default function CheckoutFormStep3() {
    ...
    return (
        <div className="d-flex flex-column align-items-center align-items-xl-start col-12 col-sm-10 col-md-8 col-lg-8 col-xl-5 col-xxl-5 mt-xl-5 pt-xl-1 ps-0 pe-0 ps-xl-2 pe-xl-3 mt-sm-5">
