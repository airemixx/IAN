        ...
        <div className="swiper mySwiper">
          ...
          >
            ...
            <SwiperSlide className={styles['swiper-slide']}>
              <a href="#">
                <img
                  src="./images/course-cover/course_1_1.avif"
                  alt="Course 1"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide className={styles['swiper-slide']}>
              <a href="#">
                <img
                  src="./images/course-cover/course_2_1.avif"
                  alt="Course 2"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide className={styles['swiper-slide']}>
              <a href="#">
                <img
                  src="./images/course-cover/course_13_1.avif"
                  alt="Course 13"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide className={styles['swiper-slide']}>
              <a href="#">
                <img
                  src="./images/course-cover/course_9_1.avif"
                  alt="Course 9"
                />
              </a>
            </SwiperSlide>
            <SwiperSlide className={styles['swiper-slide']}>
              <a href="#">
                <img
                  src="./images/course-cover/course_18_1.avif"
                  alt="Course 18"
                />
              </a>
            </SwiperSlide>
