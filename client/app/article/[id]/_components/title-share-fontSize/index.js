...
export default function TitleShareFontSize() {  
  ...
  return (  
    <>  
      {/* 標題與分享區塊 */}  
      <div className={`mb-2 ${styles['y-tag-date-share']} d-sm-flex justify-content-between align-items-end`}>  
        <div className={`${styles['y-tag-date']} d-flex align-items-center`}>  
          <div className={`px-3 py-1 ${styles['y-article-tag']}`}>產品情報</div>  
          <div className="ms-2">  
            <p className="mb-0 y-article-date">2024-12-21</p>  
          </div>  
        </div>  
        ...
        <div className={styles['y-share-icon-mb']}>  
          ...
          <a className="mx-sm-1" href="#">  
            <img src="/images/article/x-twittwr-icon-mb.svg" alt="Twitter Mobile" />  
          </a>  
          <a className="mx-sm-1" href="#">  
      ...
      {/* 主標題 */}  
      <h1 className={`mb-sm-4 ${styles['y-tag-date-share-h1']}`}>  
      ...
      <div className="mb-4 d-flex align-items-center justify-content-between text-muted">  
        <div className="d-flex align-items-center me-3">  
          ...
          />  
          <span className="ms-2">jumpman23</span>  
        </div>  
      ...
      {/* 主圖片 */}  
      <img 
        src="/images/article/sl3_stage_pat_domingo_3840x2160_teaser_image_new_0.jpg.webp"  
