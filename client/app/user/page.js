        ...
        <div className={`container py-4`}>
          <div className={`row ${styles.marginTop}`}>
            ...
            <div className="col-md-9">
              ...
              {/* 橫幅區域 */}
              <div className={`${styles.heroSection} mb-4 p-4 d-flex flex-column justify-content-center`}>
                  ...
                  <div className={styles.customCard}>
                    <form>
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className={`form-control ${styles.customInput}`} />
                      </div>
                      <div className="mb-3">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="date" className={`form-control ${styles.customInput}`} />
                      </div>
