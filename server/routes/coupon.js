...
router.get("/", async (req, res) => {
    ...
    try {
        ...
        const [result] = await pool.execute(
            `SELECT uc.id as code, c.discount_type as disType, c.type, c.name as cpName, c.start_date, c.end_date, c.discount, c.lower_purchase as minimum, c.img FROM users u 
